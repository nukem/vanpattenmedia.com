...
<html lang="en-US">
	...
	<body>
		<div id="wrap">
			<div id="top">
				<h1 style="margin-top: 38px"><?php bloginfo('name'); ?></h1>
				<h2>We're under maintenance, but you can still <a href="http://cvp.me/web" style="color: #FFF;">view our portfolio</a>.</h2>
			</div>
