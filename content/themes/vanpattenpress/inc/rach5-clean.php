...
// Better wp_title
// Output title tags, because it's the future of WP theming
function rach5_wp_title( $title ) {
	// Get the Site Name
	...
	//return '<title>' . $filtered_title . '</title>';
	return $filtered_title;
}
add_filter( 'wp_title', 'rach5_wp_title' );
